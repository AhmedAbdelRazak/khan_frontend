...
export const getPreviousBookingsOwner = (userId, token) => {
	return fetch(
		`${process.env.REACT_APP_API_URL}/all-reservations-owner/${userId}`,
		{
			method: "GET",
			headers: {
				// content type?
...
export const UpdateScheduledReservation = (
	reservationId,
	userId,
	token,
	appointment,
	...
	return fetch(
		`${process.env.REACT_APP_API_URL}/reservation/${reservationId}/${userId}`,
		{
			method: "PUT",
			headers: {
				// content type?
...
export const removeReservation = (reservationId, userId, token) => {
	return fetch(
		`${process.env.REACT_APP_API_URL}/reservation/${reservationId}/${userId}`,
		{
			method: "DELETE",
...
export const getPreviousUncompleteBookingsAdmin = (userId, token) => {
	return fetch(
		`${process.env.REACT_APP_API_URL}/all-reservations-uncomplete/${userId}`,
		{
			method: "GET",
			headers: {
				// content type?
